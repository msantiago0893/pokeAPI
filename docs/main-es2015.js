...
PokemonComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PokemonComponent, selectors: [["app-pokemon"]], viewQuery: function PokemonComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 23, vars: 6, consts: [[1, "title"], [1, "main-content"], [1, "wrapper-table"], ["appearance", "standard", 1, "wrapper-table__filter"], ["matInput", "", "placeholder", "Pikachu", 3, "keyup"], ["input", ""], ["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "id"], ["mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "name"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["matColumnDef", "action"], [4, "ngIf"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["showFirstLastButtons", "", 1, "wrapper-table__paginator", 3, "pageSizeOptions"], ["mat-header-cell", "", "mat-sort-header", ""], ["mat-cell", ""], ["mat-header-cell", ""], ["mat-button", "", "color", "primary", 3, "click"], ["aria-hidden", "false", "aria-label", "Example home icon", "fontIcon", "home"], ["mat-header-row", ""], ["mat-row", ""]], template: function PokemonComponent_Template(rf, ctx) { if (rf & 1) {
